...

{
   ...
   <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 justify-center pt-5"> 
   {
    ...
    <button  onClick={()=>{setIsOpenUpdate(true) , setCurrentCollection(collection)}} type="button" className="inline-flex items-center justify-center  text-(--secondary-color) bg-(--low-color) hover:-translate-y-1 transition-all duration-150 hover:shadow-amber-900 shadow-xs rounded-full w-9 h-9 focus:outline-none">
