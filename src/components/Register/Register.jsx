...
let schema = z.object({
    name:z.string().min(3,"Name must be at least 3 charcters").max(30,"Name must be at most 30 charcters"),
...
export function Register() {
  ...
  function RegisterFun(data){
    setIsLoading(true)
    axios.post("https://todo-nti.vercel.app/user/signup",data).then((res)=>{
        console.log(res)
