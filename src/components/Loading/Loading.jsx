...
<div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center gap-3 px-5">
{  
   Array.from({ length: 9 }).map((i)=>(
    <div role="status" className="max-w-[340px] p-4 border border-default rounded-base shadow-xs animate-pulse md:p-6" key={i}>
